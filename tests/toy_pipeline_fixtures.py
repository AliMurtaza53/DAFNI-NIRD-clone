...
from nird.geo_runtime import CONUS_TARGET_CRS
...
def network_spec(name: str) -> ToyNetworkSpec:
    if name == "three_parallel":
        return ToyNetworkSpec(
            ...
            expected_disrupted_flow_passenger=18.0,
            expected_rerouting_cost_freight=7.434457076864867,
            expected_rerouting_cost_passenger=11.151685615297303,
            expected_reroute_flow_freight=12.0,
            expected_reroute_flow_passenger=18.0,
            origin_node="n1",
            destination_node="n2",
            freight_flow=100.0,
            passenger_flow=30.0,
